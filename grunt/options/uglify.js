...
module.exports = {
	dist: {
		files: {
			...
			'dist/scripts/modules/swagger1-converter.min.js': ['dist/scripts/modules/swagger1-converter.js'],
			'dist/scripts/modules/openapi3-converter.min.js': ['dist/scripts/modules/openapi3-converter.js'],
			...
			'dist/scripts/modules/swagger-auth-ui-bootstrap-modal.min.js': ['dist/scripts/modules/swagger-auth-ui-bootstrap-modal.js'],
